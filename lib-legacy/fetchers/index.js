...
exports.opam = exports.tarball = exports.git = exports.copy = exports.base = undefined;
...
function _load_opamFetcher() {
  return _opamFetcher = _interopRequireDefault(require('./opam-fetcher.js'));
}
...
exports.opam = (_opamFetcher || _load_opamFetcher()).default;